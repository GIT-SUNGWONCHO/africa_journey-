...
export const places: Place[] = [
  {
    ...
    highlights: ['빅5(사자·표범·코끼리·버팔로·코뿔소)', '누·얼룩말 대이동', '일출 게임드라이브', '마사이족과의 만남', '풀장에서 코끼리 보이는 럭셔리 롯지(포시즌스 등)'],
    img: null,
  },
  {
    ...
    highlights: ['분화구 바닥으로 하강', '밀집된 야생 — 흑코뿔소·사자·하마', '핑크빛 홍학 호수', '인생 풍경 갱신'],
    img: null,
  },
  {
  ...
  },
  {
    ...
    highlights: ['미로 골목·잔지바르 문', '향신료 투어', '프레디 머큐리 생가', '포로다니 야시장', '다우선 석양 크루즈'],
    img: null,
  },
  {
